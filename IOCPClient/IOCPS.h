...
#include "..\Wave\Wave.h"
#include "..\Wave\WaveDevice.h"
#include "..\Wave\WaveInterface.h"
#include "..\Wave\WaveOut.h"
//#include "..\Wave\WaveIn.h"
...
typedef struct _stNOTIFYCOMPLETIONINFO {
	CString fileName;
	void* pThis;
	void* pContext;
} NOTIFYCOMPLETIONINFO;
...
#if defined TRANSFERFILEFUNCTIONALITY
	static UINT NotifyFileCompletionProc(LPVOID pParam);	//s_m
#endif //TRANSFERFILEFUNCTIONALITY
