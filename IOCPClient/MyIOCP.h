...
#define WM_FILERECEIVED  WM_NEW_CONNECTION+3
#define WM_TRAY_MESSAGE  WM_NEW_CONNECTION+4
...
public:
	...
	BOOL BuildPackageAndSendNickname(ClientContext* pContext, CString sText);	//s_m
	BOOL BuildPackageAndSendNickname(int ClientID, CString sText);				//s_m
